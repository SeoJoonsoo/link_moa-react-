...
describe('Main 페이지', () => {
  test('renders correctly', () => {
    ...
    render(<Main />);
    const mainPage = screen.getByText('main 페이지');
...
test.skip('로그아웃 시, 인트로페이지로 리다이렉션', () => {
  // Arrage
  // Act
  // Assert 이전 버튼에 .disabled 존재 확인
});
...
// 💛인트로 페이지 - 로그인 영역(임시)
test.skip('로그인하기 버튼 클릭 시, 로그인 페이지 보여줌', () => {
  // Arrage
  // Act
  // Assert
});
test.skip('회원가입 버튼 클릭 시, 회원가입 페이지 보여줌', () => {
  // Arrage
  // Act
  // Assert
});
...
test.skip('네 버튼 클릭 시, 로그아웃되어 인트로 페이지로 이동함', () => {
  // Arrage
  // Act
  // Assert
});
